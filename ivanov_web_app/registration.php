...
<body>
    <main role="main" class="d-flex align-items-center justify-content-center">
            <div class="w-30 h-100">
                ...
                <form class="form-signin w-30" action="/registration.php" method="post">
                    <h1 class="h3 font-weight-normal w-100 d-flex justify-content-center ">Данные регистрации</h1>
                    ...
                    <button class=" btn btn-lg btn-primary btn-block mt-3 teal-500" type="submit" name="submit">зарегистрироваться</button>
                </form>
            </div>
    </main>
...
if (isset($_POST["submit"])){
    ...
    if (!$login || !$password) die ("input all parametrs");
    $sql = "INSERT INTO users (username, pass) VALUES ('$login', '$password')";
    if (!mysqli_query($link, $sql)) {
        echo 'не удалось зарегистрировать';
    } else {
